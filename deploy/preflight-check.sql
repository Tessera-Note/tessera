...
--
-- Шаг 3 раздела «Ручные правки общей базы»
-- (`docs/v2-migration/03-data-and-migrations.md`) добавляет ключ сопоставления
...
BEGIN
    ...
    IF array_length(missing, 1) > 0 THEN
        RAISE EXCEPTION E'Подъём остановлен: общая база не готова.\nНе хватает: %.\nВыполните шаг 3 раздела «Ручные правки общей базы» в docs/v2-migration/03-data-and-migrations.md и повторите проверку.',
