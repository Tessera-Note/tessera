      ...
      useFactory: (environmentService: EnvironmentService) => {
        ...
        return {
          throttlers: [
            ...
            // Порог ниже, чем у прочих счетчиков, потому что цена превышения
            // здесь не отказ нам, а блокировка учетной записи в каталоге.
            { name: LDAP_LOGIN_THROTTLER, ttl: 300_000, limit: 5 },
          ],
