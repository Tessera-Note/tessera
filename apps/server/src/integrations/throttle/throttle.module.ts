...
/**
 * Именованные счетчики частоты.
 *
 * Вынесены из фабрики отдельной константой, чтобы проверка читала настоящие
 * значения, а не разбирала исходник регулярным выражением: разбор текста
 * подтверждает написание, а не поведение.
 */
