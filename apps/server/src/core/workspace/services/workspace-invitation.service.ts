...
import InvitationEmail from '@tessera/transactional/emails/invitation-email';
import { GroupUserRepo } from '@tessera/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@tessera/transactional/emails/invitation-accepted-email';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    // Приглашение принимает еще не аутентифицированный пользователь.
    this.auditService.setActorId(newUser.id);
