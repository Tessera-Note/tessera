...
export const auditEventLabels: Record<string, string> = {
  ...
  "user.mfa_reset": "Reset MFA for member",
  ...
  "page.restricted": "Page access restricted",
...
export const eventFilterOptions: EventGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: "user.deleted", label: "Deleted member" },
      ...
      { value: "user.mfa_reset", label: "Reset MFA for member" },
      {
        value: "user.sso_unlinked",
        label: "Removed sign-in provider link",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { value: "page.restricted", label: "Page access restricted" },
