...
<div data-section="share" class="min-h-screen bg-surface-muted px-4 py-10 text-text">
  <!--
    Пять шестых, а не три: рядом с текстом стоят два столбца — дерево с поиском
    и оглавление, — и на трёх шестых самому тексту оставалось бы меньше трети
    ширины.
  -->
  <div class="mx-auto" class:max-w-5xl={!shareWidth.wide}>
