 ...
 *
 * Формы перенесены из v1 (`apps/client/src/ee/base/types/base.types.ts`)
 * дословно. Совпадение обязательно: настройки представления лежат в общей
 * базе колонкой `config`, и своя форма означала бы, что представление,
