 ...
 *
 * Состав тот же, что в v1 (`apps/client/src/features/comment/components/
 * comment-editor.tsx`): `StarterKit` без своей ссылки, ссылка из общего пакета
 * и упоминание. Упоминание берётся оттуда же, что и у страницы, — узел один,
 * и вторая его запись расходилась бы с первой.
 */
