 ...
 *
 * Список перенесён из v1 (`apps/server/src/collaboration/collaboration.util.ts`)
 * состав в состав. Это не дублирование, а переезд: `apps/server` на ветке v2
 * заменяется, и после его удаления живой список останется один.
 *
