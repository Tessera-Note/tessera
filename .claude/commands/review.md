...
2. доменный ревьюер: `schema-reviewer` при правках слоя данных, `i18n-reviewer` при правках текстов и словарей. Если ни то, ни другое, написать «неприменимо»
...
5. линт и прогон тестов затронутого пакета
