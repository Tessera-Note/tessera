...
[ -d "$ROOT/apps/web/static/excalidraw-assets/fonts" ] || issues+=("нет шрифтов Excalidraw, выгрузка диаграммы уедет без букв: node apps/web/scripts/copy-excalidraw-assets.mjs")
